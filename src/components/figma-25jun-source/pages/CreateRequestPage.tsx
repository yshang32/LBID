...
function WorkflowPreview() {
  const items = [{ icon: FileText, title: "LBID Review", body: "Request checked within 2 hours" }, { icon: Users, title: "Forwarder Invitation", body: "Qualified partners receive the brief" }, { icon: LockKeyhole, title: "Sealed Bidding", body: "Fixed three-hour bidding window" }, { icon: PackageCheck, title: "Compare & Award", body: "Choose price, fit and capability" }]
