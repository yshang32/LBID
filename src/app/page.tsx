  ...
  return (
    <main className="mx-auto grid min-h-screen w-full max-w-4xl place-items-center px-4 py-12 text-center sm:px-6">
      <section className="w-full">
        <div className="mx-auto flex h-28 w-72 items-center justify-center rounded-xl border border-lblue/10 bg-white/88 p-4 shadow-[0_24px_70px_rgba(27,43,94,0.10)] backdrop-blur-xl">
          <BrandMark markClassName="h-16 w-64" />
        </div>
